...
drawmodel(void)
{
    if (!pmodel) 
	{
		...
		pmodel = glmReadOBJ("/home/luis/Documentos/github/Computacion-grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Projection_NatteRobbins/data/al.obj");
...
screen_menu(int value)
{
    ...
    case 'a':
        //name = "data/al.obj";
		name = "/home/luis/Documentos/github/Computacion-grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Projection_NatteRobbins/data/al.obj";

		break;
    case 's':
        //name = "data/soccerball.obj";
		name = "/home/luis/Documentos/github/Computacion-grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Projection_NatteRobbins/data/soccerball.obj";

		break;
    case 'd':
        //name = "data/dolphins.obj";
		name = "/home/luis/Documentos/github/Computacion-grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Projection_NatteRobbins/data/dolphins.obj";

        break;
    case 'f':
        //name = "data/flowers.obj";
		name = "/home/luis/Documentos/github/Computacion-grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Projection_NatteRobbins/data/flowers.obj";

        break;
    case 'j':
        //name = "data/f-16.obj";
		name = "/home/luis/Documentos/github/Computacion-grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Projection_NatteRobbins/data/f-16.obj";

        break;
    case 'p':
        //name = "data/porsche.obj";
		name = "/home/luis/Documentos/github/Computacion-grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Projection_NatteRobbins/data/porsche.obj";

        break;
    case 'r':
        //name = "data/rose+vase.obj";
		name = "/home/luis/Documentos/github/Computacion-grafica/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Projection_NatteRobbins/data/rose+vase.obj";
