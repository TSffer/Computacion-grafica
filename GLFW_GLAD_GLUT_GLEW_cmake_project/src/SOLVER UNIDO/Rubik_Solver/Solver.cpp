...
Solver::Solver(Cube c) {
	...
	thread th1(readData, "/home/angelcs/Documentos/SEMESTRE IX/COMP GRAFICA/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Rubik_Solver/database/phase1", 1);
	thread th2(readData, "/home/angelcs/Documentos/SEMESTRE IX/COMP GRAFICA/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Rubik_Solver/database/phase2", 2);
	thread th3(readData, "/home/angelcs/Documentos/SEMESTRE IX/COMP GRAFICA/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Rubik_Solver/database/phase3", 3);
	thread th4(readData, "/home/angelcs/Documentos/SEMESTRE IX/COMP GRAFICA/GLFW_GLAD_GLUT_GLEW_cmake_project/src/Rubik_Solver/database/phase4", 4);
	th1.join();
	th2.join();
	th3.join();
	th4.join();
